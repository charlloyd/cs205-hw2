...
\item \pline{CUDA}
 ...
 \begin{enumerate}[label=(\alph*)]
    \item \pline{First benchmark a naive version (nested three loop matrix multiplication CUDA parallel program) against the reference implementation in CUBLAS. Generate a performance plot of throughput (GFlop/s) for problem sizes $n = 26,210,216$ for single precision floating point real numbers and compare against CUBLAS.}\\
